...
export const de = {
  ...
  funnel: {
    ...
    bank: {
      ...
      storageNotice:
        "Wir speichern Ihre IBAN nur verkürzt — die ersten vier und die letzten vier Stellen. Die vollständige Nummer bleibt beim Zahlungsdienstleister.",
    },
    review: {
    ...
    processing: {
      title: "Ihre Auszahlung wird vorbereitet",
      body: "Die Kontogebühr ist eingegangen. Wir weisen die Überweisung an — das dauert in der Regel ein bis zwei Werktage.",
      doneTitle: "Das Geld ist unterwegs",
      doneBody: "Die Überweisung ist angewiesen. Die Gutschrift auf Ihrem Konto hängt von Ihrer Bank ab.",
      doneHint: "Vorgangsnummer {reference}. Alle Unterlagen bleiben in Ihrem Konto verfügbar.",
      refreshHint: "Diese Seite aktualisiert sich von selbst. Sie können sie auch schließen — wir schreiben Ihnen.",
      feeAmount: "Bezahlte Kontogebühr",
      feeReference: "Zahlungsreferenz",
      feeMethod: "Zahlungsart",
      feePaidAt: "Bezahlt am",
      toAccount: "Zu meinem Konto",
      progressLabel: "Fortschritt der Auszahlung",
      progressWaiting: "Auszahlung wird bearbeitet",
      progressDone: "Auszahlung erfolgt",
      steps: {
        fee: "Gebühr eingegangen",
        checks: "Letzte Prüfungen",
        payout: "Überweisung angewiesen",
      },
    },
  },
  ...
  backoffice: {
    ...
    approveBlockedTitle: "Erst die Unterlagen prüfen",
    approveBlockedBody:
      "Diese Unterlagen sind noch nicht freigegeben. Solange eine davon offen ist, kann der Antrag nicht bewilligt werden:",
    outcome: { ACCEPT: "Zusage", REFER: "Manuelle Prüfung", DECLINE: "Absage" },
    overrideTitle: "Entscheidung übersteuern",
    overrideReason: "Begründung",
    overrideReasonHint: "Pflichtangabe. Wird dauerhaft im Prüfpfad gespeichert.",
    overrideApprove: "Zusagen",
    overrideDecline: "Ablehnen",
    overrideDone: "Übersteuert von {agent} am {date}",
...
Unterschrift     {signatureHash}`,
  ...
  errors: {
    ...
    tooYoung: "Für einen Kreditvertrag müssen Sie volljährig sein.",
